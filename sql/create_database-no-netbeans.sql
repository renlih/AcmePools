...
--select c.state from customer c ;
...
--alter table customer rename "NAME" to name;
...
CREATE TABLE MICRO_MARKET (ZIP_CODE VARCHAR(10) NOT NULL, RADIUS real, AREA_LENGTH real, AREA_WIDTH real, PRIMARY KEY (ZIP_CODE));
